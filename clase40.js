/**
 * Un closure, básicamente, es una función que recuerda 
 * el estado de las variables al momento de ser invocada, 
...
saludoArgentino('Ignacio');
saludoMexicano('Ignacio');
saludoColombiano('Ignacio');